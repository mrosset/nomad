...
* Build from source
  ...
  - Then build the package with
    ...
    #+end_src
* Run from source
  - To run a local build of nomad, without actually installing it. For
    example, if you are hacking on the nomad Cpp source code and want
    to test your changes after you've compiled it.
    #+begin_src shell
